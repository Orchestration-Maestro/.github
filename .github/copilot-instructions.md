...
│   ├── README.md                               # The banner and the pillar icons live in ../profile/, next to the page that shows them
...
│   ├── icons/                                  # The four pillar icons on the organization page
│   │   ├── maintainability.png                 # PNG image: maintainability
│   │   ├── quality.png                         # PNG image: quality
│   │   ├── security.png                        # PNG image: security
│   │   └── speed.png                           # PNG image: speed
│   ├── README.md                               # Never reached
│   └── banner.jpg                              # JPEG image: banner
├── scripts/                                    # Maintenance scripts
│   ├── copilot-instructions.py                 # Write a repository's .github/copilot-instructions.md, its Copilot guide
