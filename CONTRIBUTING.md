...
| Organization CI | Rust repositories pass the `ci.yml` of [maestro-rust-workflows](https://github.com/Orchestration-Maestro/maestro-rust-workflows), a repository without Rust its `hygiene.yml`; the organization runs both, no repository can edit or skip them |
